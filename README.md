...
| [`docs/REGISTRO_SOGGETTI.md`](docs/REGISTRO_SOGGETTI.md) | Registro dei soggetti che impara dai revisori: nomi simili (varianti/soggetti diversi), refusi nel nome, soggetto già inserito, notizie confermate, ruoli negli articoli e flag PEP, audit |
